...
// Lab#9-C2F\F2C\K2C\C2K\K2F\F2K Methods
public class TemperatureConverterMethods9 {
	...
	public static void main(String[] args) throws IOException {
		...
		double C, K, F; // Variables for temperature values: Celsius, Kelvin,
						// Fahrenheit
		...
		if (choice == 1) {
			outputFile.println("Fahrenheit" + "\t\t" + "Celsius"); // table
																	// header
			...
			while (inputFile.hasNext()) {
				...
				outputFile.println(str + "\t\t" + C); // Temp. in/out two
														// columns
			...
			outputFile.println("Celsius" + "\t\t" + "Fahrenheit"); // table
																	// header
			outputFile.println("___________________________");
