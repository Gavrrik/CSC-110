import javax.swing.JOptionPane; 
 ...
 { 
     ...
     public static void main(String[] args) { 
        ...
        //constants  
         final double SECONDS_PER_MINUTE = 60; //Seconds in a minute  
       ...
       //input inserted into the JOptionPane is a String and it is stored and returned as a String.
       //Java cannot convert between strings and number by itself, so we use parseDouble to convert to double.
       seconds= Double.parseDouble (input); 
         ...
         // Display the number of minutes  A
