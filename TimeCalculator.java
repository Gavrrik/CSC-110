...
public class TimeCalculator {
	...
	public static void main(String[] args) {
		...
		// input inserted into the JOptionPane is a String and it is stored and
		// returned as a String.
		// Java cannot convert between strings and number by itself, so we use
		// parseDouble to convert to double.
